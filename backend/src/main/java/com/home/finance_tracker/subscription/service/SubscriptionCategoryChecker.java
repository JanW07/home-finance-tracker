...
public class SubscriptionCategoryChecker implements CategoryUsageChecker {
    ...
    @Autowired
    public SubscriptionCategoryChecker(SubscriptionRepository subscriptionRepository) {
    ...
    public CategoryUsageResult checkUsage(Long categoryId, Long userId){
        ...
        return exists ? CategoryUsageResult.usedIn("Subscriptions") : CategoryUsageResult.unused();
    }
}
